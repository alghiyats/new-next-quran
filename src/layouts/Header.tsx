          ...
          <div className="ml-2 flex gap-x-2">
            <Link href={'/'}>
              <div
                ...
                }flex cursor-pointer items-center gap-x-1 rounded-md  p-2 sm:py-2 sm:px-4 hover:bg-gray-100`}>
                <svg
            ...
            <Link href={'/surah'}>
              <div
                className={`${
                  router.pathname === '/surah' ? 'bg-gray-100 ' : ''
                }flex cursor-pointer items-center gap-x-1 rounded-md  p-2 sm:py-2 sm:px-4 hover:bg-gray-100`}>
                <svg
            ...
            <div className="flex cursor-pointer items-center gap-x-1 rounded-md p-2 sm:py-2 sm:px-4 hover:bg-gray-100">
              <div className="relative">
                ...
                <span className="flex absolute -top-2 -right-2 h-4 w-4 items-center justify-center rounded-full bg-red-500 p-2 text-xs text-white">
                  3
                </span>
              </div>
              <span className="hidden sm:block text-sm font-medium">
            ...
            <div
              ...
              className="flex cursor-pointer select-none items-center rounded-md p-2 hover:bg-gray-100">
              {theme !== 'dark' ? (
                <svg
                ...
                <svg
                  className="hidden dark:block h-5 w-5 fill-gray-500"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg">
                  <g strokeWidth={0} />
                  <g strokeLinecap="round" strokeLinejoin="round" />
