        ...
        <div className="flex justify-between max-w-[1000px] mx-auto px-6">
          ...
          <div className="ml-2 flex gap-x-2">
            {router.pathname === '/' && (
              <Link href={'/'}>
                <div
                  className={`bg-gray-100 dark:bg-gray-800 flex cursor-pointer items-center gap-x-1 rounded-md  p-2 sm:py-2 sm:px-4 hover:bg-gray-200 hover:dark:bg-gray-700`}>
                  <svg
