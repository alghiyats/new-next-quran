...
export default function MobileMenu() {
   ...
   return (
      <div className='lg:hidden fixed rounded-[12px_12px_0_0] bg-mobB text-mobT shadow-[0_-10px_25px_-5px_rgba(0,0,0,0.1)] z-[5] text-xs px-5 py-0 bottom-0 inset-x-0 mt-0 dark:bg-darkBa dark:text-darkTa'>
