...
export default function Toggle({ onToggle, isOpen }) {
   return (
      <div
         onClick={onToggle}
         className='flex bg-inherit absolute inset-x-0 top-0 px-[10px] z-[2]'>
         <div
            className={clsx(
               'absolute left-[-45px] top-4 transition-all duration-100 ease-ease',
               isOpen && 'invisible opacity-0'
            )}>
            <svg
               className='w-5 h-5 absolute right-[-2px] top-[-19px] fill-contentB dark:fill-darkBa rotate-[92deg] transition-[inherit]'
               viewBox='0 0 160 160'>
               <path
                  d='M0-10,150,0l10,150S137.643,80.734,100.143,43.234,0-10,0-10Z'
                  transform='translate(0 10)'></path>
            </svg>
            <span className='flex items-center justify-center w-[45px] h-10 rounded-[20px_0_0_20px] bg-contentB dark:bg-darkBa shadow-[0_5px_20px_0_rgba(0,0,0,.1)] transition-[inherit]'>
               <svg
            ...
            <svg
               className='w-5 h-5 absolute top-auto right-[-2px] bottom-[-19px] fill-contentB dark:fill-darkBa rotate-[-2deg] transition-[inherit]'
               viewBox='0 0 160 160'>
               <path
                  d='M0-10,150,0l10,150S137.643,80.734,100.143,43.234,0-10,0-10Z'
                  transform='translate(0 10)'></path>
         ...
         <div
            className='flex w-full before:content-[attr(data-text)] before:grow before:pt-6 before:px-[10px] before:text-[90%] before:opacity-70'
            data-text='Jump'>
            <span
