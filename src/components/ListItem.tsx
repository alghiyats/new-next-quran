...
const ListItem = ({ data }: Props) => {
  return (
    <Link href={`/surah/${data.name.transliteration.id.toLowerCase()}`}>
      <div className="group pl-4 p-6 flex shadow-md hover:shadow-lg border dark:border-gray-500 duration-300 rounded-md dark:shadow-gray-500 justify-between dark:bg-slate-900">
